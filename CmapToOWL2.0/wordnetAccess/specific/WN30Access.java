...
public class WN30Access implements wordnetAccess.WNAccess{
	//	File paths
	public  String wnDir = "WordNet3.0";
	...
	public  String[] domainFilenames = {"wn-domains-3.2-20070223","wn-domains-hierachy"};

//	-------------------------------------------------------------------------------------------------	
	public WN30Access(String dataPath){
		//check for files
